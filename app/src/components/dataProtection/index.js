  ...
  render() {
    return (
        ...
        <Header />
            ...
            <span> Every organisation in the UK that processes personal data electronically is required to abide by data protection regulations. These are made up of the Data Protection Act 2018, the Digital Economy Act and the GDPR.
